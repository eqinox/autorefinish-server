  ...
  'strapi::cors',
  {
    ...
    config: {
      contentSecurityPolicy: {
        useDefaults: true,
        directives: {
          "img-src": ["'self'", "data:", "blob:", "https://market-assets.strapi.io", "https://autorefinish.s3.eu-north-1.amazonaws.com"],
          ...
          "connect-src": ["'self'", "blob:", "https://autorefinish.s3.eu-north-1.amazonaws.com"], // Allow connections to specified sources
